...
<div style="display: flex; gap: 20px; align-items: flex-start;">
  ...
  <div style="flex: 1 1 50%; max-width: 50%;">
    Il vero capolavoro del tour. L'anello delle **Crete Senesi** è stato un colpo di genio.<br>
    <b>Nota Personale:</b> Per come sono io, questa è stata la tratta più bella. I panorami, le curve, la strada che serpeggiava sono stati momenti impagabili.
  </div>
</div>
